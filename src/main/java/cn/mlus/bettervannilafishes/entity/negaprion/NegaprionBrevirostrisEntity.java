...
public class NegaprionBrevirostrisEntity extends BvfWaterAnimal implements BvfEntity<NegaprionBrevirostrisEntity>, Bucketable, VariantHolder<NegaprionBrevirostrisEntity.Variant> {
    public NegaprionBrevirostrisEntity(EntityType<? extends WaterAnimal> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.moveControl = new BvfWaterAnimalMoveControl(true, this);
        this.lookControl = new SmoothSwimmingLookControl(this, 10);
        animator = new SharkAnimator<>(this);
    }
    private final GeneralAnimator<NegaprionBrevirostrisEntity> animator;

    private static final EntityDataAccessor<Integer> DATA_VARIANT = SynchedEntityData.defineId(NegaprionBrevirostrisEntity.class, EntityDataSerializers.INT);
    ...
    public ItemEntity spawnAtLocation(@NotNull ItemStack pStack) {
        if (pStack.is(BvfItems.NEGAPRION_BREVIROSTRIS.get())) {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllerRegistrar) {
        AnimationController<NegaprionBrevirostrisEntity> main = new AnimationController<>(this, "main", 4, state -> {
        ...
        AnimationController<NegaprionBrevirostrisEntity> extra = new AnimationController<>(this, "extra", 4, state -> PlayState.STOP)
    ...
    public GeneralAnimator<NegaprionBrevirostrisEntity> getAnimator() {
        return animator;
    }
    ...
    public @NotNull ItemStack getBucketItemStack() {
        return new ItemStack(BvfItems.NEGAPRION_BREVIROSTRIS_BUCKET.get());
    }
