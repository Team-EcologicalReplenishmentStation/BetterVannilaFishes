package cn.mlus.bettervannilafishes.entity.negaprion;
...
public class NegaprionAcutidensEntity extends BvfWaterAnimal implements BvfEntity<NegaprionAcutidensEntity>, Bucketable, VariantHolder<NegaprionAcutidensEntity.Variant> {
    public NegaprionAcutidensEntity(EntityType<? extends WaterAnimal> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.moveControl = new BvfWaterAnimalMoveControl(true, this);
        this.lookControl = new SmoothSwimmingLookControl(this, 10);
        animator = new SharkAnimator<>(this);
    }
    private final GeneralAnimator<NegaprionAcutidensEntity> animator;

    private static final EntityDataAccessor<Integer> DATA_VARIANT = SynchedEntityData.defineId(NegaprionAcutidensEntity.class, EntityDataSerializers.INT);
    ...
    public ItemEntity spawnAtLocation(@NotNull ItemStack pStack) {
        if (pStack.is(BvfItems.NEGAPRION_ACUTIDENS.get())) {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllerRegistrar) {
        AnimationController<NegaprionAcutidensEntity> main = new AnimationController<>(this, "main", 4, state -> {
        ...
        AnimationController<NegaprionAcutidensEntity> extra = new AnimationController<>(this, "extra", 4, state -> PlayState.STOP)
    ...
    public GeneralAnimator<NegaprionAcutidensEntity> getAnimator() {
        return animator;
    }
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(3, new NearestAttackableTargetGoal<>(this, LivingEntity.class, true,
                entity -> entity.hasEffect(BvfMobEffects.BLEEDING) && entity.getType() != this.getType()));
    }
    ...
    public @NotNull ItemStack getBucketItemStack() {
        return new ItemStack(BvfItems.NEGAPRION_ACUTIDENS_BUCKET.get());
    }
    ...
    public enum Variant implements StringRepresentable {
        ...
        private static Variant getSpawnVariant(RandomSource pRandom) {
            ...
            return pRandom.nextBoolean() ? ORIGINAL : LIGHT;
        }
    }
}
