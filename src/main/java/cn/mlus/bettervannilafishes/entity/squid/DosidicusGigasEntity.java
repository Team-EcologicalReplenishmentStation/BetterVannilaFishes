...
public class DosidicusGigasEntity extends BvfWaterAnimal implements BvfEntity<DosidicusGigasEntity>, Bucketable {
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_COLOR_STATE, 0);
    }
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllerRegistrar) {
        ...
        AnimationController<DosidicusGigasEntity> extra = new AnimationController<>(this, "extra", 0, state -> software.bernie.geckolib.core.object.PlayState.STOP)
    ...
    public static AttributeSupplier.@NotNull Builder createAttributes() {
        return Mob.createMobAttributes()
                ...
                .add(ForgeMod.SWIM_SPEED.get(), 1.3);
    }
