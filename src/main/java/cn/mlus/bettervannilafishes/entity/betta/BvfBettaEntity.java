...
public abstract class BvfBettaEntity extends BvfAbstractFish implements BvfEntity<BvfBettaEntity> {
    private final GeneralAnimator<BvfBettaEntity> animator;

    public BvfBettaEntity(EntityType<? extends AbstractFish> pEntityType, Level pLevel) {
    ...
    @Override
    public GeneralAnimator<BvfBettaEntity> getAnimator() {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllerRegistrar) {
        AnimationController<BvfBettaEntity> main = new AnimationController<>(this, "main", 5, state -> {
