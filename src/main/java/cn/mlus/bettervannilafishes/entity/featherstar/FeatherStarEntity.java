...
public class FeatherStarEntity extends WaterAnimal implements GeoEntity, BvfEntity<FeatherStarEntity>, Bucketable {
    ...
    public @NotNull ItemStack getBucketItemStack() {
        return new ItemStack(BvfItems.FEATHER_STAR_BUCKET.get());
    }
            ...
            if(tickCount % 100 == 0){
                ...
                entities.forEach(entity -> {
                    if (entity instanceof LivingEntity livingEntity) {
                        livingEntity.addEffect(new MobEffectInstance(BvfMobEffects.PURIFICATION.get(),200,0,false,false,true));
                    }
                });
