...
public abstract class BvfClownfishEntity extends BvfAbstractFish implements BvfEntity<BvfClownfishEntity> {
    public BvfClownfishEntity(EntityType<? extends AbstractFish> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.moveControl = new BvfFishMoveControl(this,false);
        animator = new BvfFishAnimator<>(this);
    }

    private final GeneralAnimator<BvfClownfishEntity> animator;
    public GeneralAnimator<BvfClownfishEntity> getAnimator() {
        return animator;
    }
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllerRegistrar) {
        AnimationController<BvfClownfishEntity> main = new AnimationController<>(this, "main", 5, state -> {
