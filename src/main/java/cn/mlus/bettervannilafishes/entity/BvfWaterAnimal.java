...
public abstract class BvfWaterAnimal extends WaterAnimal implements GeoEntity, Bucketable {
    ...
    protected BvfWaterAnimal(EntityType<? extends WaterAnimal> pEntityType, Level pLevel) {
    ...
    private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(BvfWaterAnimal.class, EntityDataSerializers.BOOLEAN);
    ...
    public void die(@NotNull DamageSource source) {
        this.killedByTrident = source.is(DamageTypes.TRIDENT)
                ...
                && attacker.getMainHandItem().is(net.minecraft.world.item.Items.TRIDENT);
        super.die(source);
    }
    ...
    public ItemEntity spawnAtLocation(@NotNull ItemStack stack) {
        if (this.killedByTrident && stack.is(net.minecraft.tags.ItemTags.FISHES) && this instanceof BvfEntity<?> entity) {
            stack.getOrCreateTag().putFloat("Scale", entity.getScale());
        }
    ...
    public BvfWaterAnimal startFollowing(BvfWaterAnimal pLeader) {
        this.leader = pLeader;
        pLeader.addFollower();
        return pLeader;
    }
    ...
    public void tick() {
        ...
        if (this.hasFollowers() && this.level().random.nextInt(200) == 1) {
            List<? extends BvfWaterAnimal> $$0 = this.level().getEntitiesOfClass(this.getClass(), this.getBoundingBox().inflate(14.0, 14.0, 14.0));
            if ($$0.size() <= 1) {
                this.schoolSize = 1;
            }
        }
    ...
    public void addFollowers(Stream<? extends BvfWaterAnimal> pFollowers) {
    ...
    public SpawnGroupData finalizeSpawn(@NotNull ServerLevelAccessor pLevel, @NotNull DifficultyInstance pDifficulty, @NotNull MobSpawnType pReason, @Nullable SpawnGroupData pSpawnData, @Nullable CompoundTag pDataTag) {
        ...
        if (pSpawnData == null) {
            pSpawnData = new BvfWaterAnimal.SchoolSpawnGroupData(this);
        } else {
            this.startFollowing(((BvfWaterAnimal.SchoolSpawnGroupData)pSpawnData).leader);
        }
    ...
    public static class SchoolSpawnGroupData implements SpawnGroupData {
        public final BvfWaterAnimal leader;

        public SchoolSpawnGroupData(BvfWaterAnimal pLeader) {
            this.leader = pLeader;
        }
    }
}
