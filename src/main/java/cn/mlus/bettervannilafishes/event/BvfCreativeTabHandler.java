...
public class BvfCreativeTabHandler {
    ...
    public static void addCreative(BuildCreativeModeTabContentsEvent event) {
        ...
        if(event.getTabKey() == CreativeModeTabs.TOOLS_AND_UTILITIES){
           ...
           event.insertAfter(Items.AXOLOTL_BUCKET.getDefaultInstance(), BvfItems.GALEOCERDO_CUVIER_BUCKET.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
           event.insertAfter(Items.AXOLOTL_BUCKET.getDefaultInstance(), BvfItems.ACANTHURUS_ACHILLES_BUCKET.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
           event.insertAfter(Items.AXOLOTL_BUCKET.getDefaultInstance(), BvfItems.ACANTHURUS_LEUCOSTERNON_BUCKET.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
           event.insertAfter(Items.AXOLOTL_BUCKET.getDefaultInstance(), BvfItems.PARACANTHURUS_HEPATUS_BUCKET.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
           event.insertAfter(Items.AXOLOTL_BUCKET.getDefaultInstance(), BvfItems.ACANTHURUS_TRIOSTEGUS_BUCKET.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
           event.insertAfter(Items.AXOLOTL_BUCKET.getDefaultInstance(), BvfItems.ACANTHURUS_NIGRICANS_BUCKET.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
           event.insertAfter(Items.AXOLOTL_BUCKET.getDefaultInstance(), BvfItems.ACANTHURUS_LINEATUS_BUCKET.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
           event.insertAfter(Items.AXOLOTL_BUCKET.getDefaultInstance(), BvfItems.AUSTRALOHEROS_FACETUS_BUCKET.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
           event.insertAfter(Items.AXOLOTL_BUCKET.getDefaultInstance(), BvfItems.CICHLASOMA_BIMACULATUM_BUCKET.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
           event.insertAfter(Items.AXOLOTL_BUCKET.getDefaultInstance(), BvfItems.KROBIA_GUIANENSIS_BUCKET.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
           event.insertAfter(Items.AXOLOTL_BUCKET.getDefaultInstance(), BvfItems.AEQUIDENS_TETRAMERUS_BUCKET.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
           event.insertAfter(Items.AXOLOTL_BUCKET.getDefaultInstance(), BvfItems.GYMNOGEOPHAGUS_BALZANII_BUCKET.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
           event.insertAfter(Items.AXOLOTL_BUCKET.getDefaultInstance(), BvfItems.ASTRONOTUS_OCELLATUS_BUCKET.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
           event.insertAfter(Items.AXOLOTL_BUCKET.getDefaultInstance(), BvfItems.AMPHIPRION_OCELLARIS_BUCKET.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
           event.insertAfter(Items.AXOLOTL_BUCKET.getDefaultInstance(), BvfItems.PREMNAS_BIACULEATUS_BUCKET.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
           event.insertAfter(Items.AXOLOTL_BUCKET.getDefaultInstance(), BvfItems.AMPHIPRION_POLYMNUS_BUCKET.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
           event.insertAfter(Items.AXOLOTL_BUCKET.getDefaultInstance(), BvfItems.AMPHIPRION_PERIDERAION_BUCKET.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
           event.insertAfter(Items.AXOLOTL_BUCKET.getDefaultInstance(), BvfItems.AMPHIPRION_CLARKII_BUCKET.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
           event.insertAfter(Items.AXOLOTL_BUCKET.getDefaultInstance(), BvfItems.AMPHIPRION_PERCULA_BUCKET.get().getDefaultInstance(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
        }
