...
public class LionfishModel extends BvfModel<Lionfish> {
    @Override public ResourceLocation getModelResource(Lionfish entity) {
        return BetterVannilaFishes.prefix("geo/entity/lionfish.geo.json");
    }
    @Override public ResourceLocation getAnimationResource(Lionfish entity) {
        return BetterVannilaFishes.prefix("animations/entity/lionfish.animation.json");
    }
    @Override public ResourceLocation getTextureResource(Lionfish entity) {
