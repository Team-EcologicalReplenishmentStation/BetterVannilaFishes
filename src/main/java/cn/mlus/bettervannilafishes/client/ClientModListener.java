...
public final class ClientModListener {
	...
	public static void registerRenderers(final EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerBlockEntityRenderer(BvfBlockEntities.OBSCURE_PUFFER_SPECIMEN.get(), (context) -> new BvfSpecimenRenderer());
		event.registerBlockEntityRenderer(BvfBlockEntities.YELLOW_FIN_PUFFER_SPECIMEN.get(), (context) -> new BvfSpecimenRenderer());
		event.registerBlockEntityRenderer(BvfBlockEntities.PORCUPINE_FISH_SPECIMEN.get(), (context) -> new BvfSpecimenRenderer());
