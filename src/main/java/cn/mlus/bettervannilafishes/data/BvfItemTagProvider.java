...
public class BvfItemTagProvider extends ItemTagsProvider{
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider) {
        this.tag(ItemTags.FISHES)
                ...
                .add(BvfItems.CHANNA_MICROPELTES.get())
                .add(BvfItems.CHANNA_ARGUS.get())
                .add(BvfItems.ELOPICHTHYS_BAMBUSA.get())
        ...
        this.tag(ItemTags.AXOLOTL_TEMPT_ITEMS)
                ...
                .add(BvfItems.CHANNA_MICROPELTES_BUCKET.get())
                .add(BvfItems.CHANNA_ARGUS_BUCKET.get())
                .add(BvfItems.ELOPICHTHYS_BAMBUSA_BUCKET.get())
