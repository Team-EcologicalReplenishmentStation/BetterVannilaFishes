...
public class BvfItemTagProvider extends ItemTagsProvider{
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider) {
        this.tag(ItemTags.FISHES)
                ...
                .add(BvfItems.AMPHIPRION_AKINDYNOS.get())
                .add(BvfItems.AMPHIPRION_BICINCTUS.get())
                .add(BvfItems.AMPHIPRION_CHRYSOGASTER.get())
                .add(BvfItems.AMPHIPRION_CHRYSOPTERUS.get())
                .add(BvfItems.AMPHIPRION_LATEZONATUS.get())
                .add(BvfItems.AMPHIPRION_MCCULLOCHI.get())
                .add(BvfItems.AMPHIPRION_MELANOPUS.get())
                .add(BvfItems.AMPHIPRION_TRICINCTUS.get())
                .add(BvfItems.BETTA_SPLENDENS.get())
                .add(BvfItems.BETTA_IMBELLIS.get())
                .add(BvfItems.BETTA_SMARAGDINA.get())
                .add(BvfItems.BETTA_PICTA.get())
        ...
        this.tag(ItemTags.AXOLOTL_TEMPT_ITEMS)
                ...
                .add(BvfItems.ZHIKONG_SCALLOP_BUCKET.get())
                .add(BvfItems.BAY_SCALLOP_BUCKET.get())
                .add(BvfItems.YESSO_SCALLOP_BUCKET.get())
                ...
                .add(BvfItems.AMPHIPRION_AKINDYNOS_BUCKET.get())
                .add(BvfItems.AMPHIPRION_BICINCTUS_BUCKET.get())
                .add(BvfItems.AMPHIPRION_CHRYSOGASTER_BUCKET.get())
                .add(BvfItems.AMPHIPRION_CHRYSOPTERUS_BUCKET.get())
                .add(BvfItems.AMPHIPRION_LATEZONATUS_BUCKET.get())
                .add(BvfItems.AMPHIPRION_MCCULLOCHI_BUCKET.get())
                .add(BvfItems.AMPHIPRION_MELANOPUS_BUCKET.get())
                .add(BvfItems.AMPHIPRION_TRICINCTUS_BUCKET.get())
                .add(BvfItems.BETTA_SPLENDENS_BUCKET.get())
                .add(BvfItems.BETTA_IMBELLIS_BUCKET.get())
                .add(BvfItems.BETTA_SMARAGDINA_BUCKET.get())
                .add(BvfItems.BETTA_PICTA_BUCKET.get())
                .add(BvfItems.BETTA_SIMPLEX_BUCKET.get())
                .add(BvfItems.BETTA_BROWNORUM_BUCKET.get())
                .add(BvfItems.MEGALOPS_ATLANTICUS_BUCKET.get());
    }
}
