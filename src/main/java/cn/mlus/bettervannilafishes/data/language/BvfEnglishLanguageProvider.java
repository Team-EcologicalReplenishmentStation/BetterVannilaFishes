...
public class BvfEnglishLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.add(BvfItems.PARACANTHURUS_HEPATUS_SPECIMEN.get(),"Blue Tang Specimen");
        ...
        this.add(BvfItems.ACANTHURUS_LINEATUS_SPECIMEN.get(),"Lined Surgeonfish Specimen");
        this.add(BvfItems.CHAETODON_STRIATUS_SPECIMEN.get(),"Chaetodon striatus Specimen");
        this.add(BvfItems.CHAETODON_UNIMACULATUS_SPECIMEN.get(),"Chaetodon unimaculatus Specimen");
        this.add(BvfItems.CHAETODON_AURIGA_SPECIMEN.get(),"Chaetodon auriga Specimen");
        this.add(BvfItems.CHAETODON_COLLARE_SPECIMEN.get(),"Chaetodon collare Specimen");
        this.add(BvfItems.CHAETODON_RETICULATUS_SPECIMEN.get(),"Chaetodon reticulatus Specimen");
        this.add(BvfItems.CHAETODON_SPECULUM_SPECIMEN.get(),"Chaetodon speculum Specimen");
        this.add(BvfItems.AMPHIPRION_OCELLARIS_SPECIMEN.get(),"Ocellaris Clownfish Specimen");
        this.add(BvfItems.PREMNAS_BIACULEATUS_SPECIMEN.get(),"Spine-cheeked Clownfish Specimen");
        ...
        this.add(BvfItems.AMPHIPRION_PERCULA_SPECIMEN.get(),"Orange Clownfish Specimen");
        this.add(BvfItems.AMPHIPRION_AKINDYNOS_SPECIMEN.get(),"Barrier Reef Clownfish Specimen");
        this.add(BvfItems.AMPHIPRION_BICINCTUS_SPECIMEN.get(),"Two-band Clownfish Specimen");
        this.add(BvfItems.AMPHIPRION_CHRYSOGASTER_SPECIMEN.get(),"Mauritian Clownfish Specimen");
        this.add(BvfItems.AMPHIPRION_CHRYSOPTERUS_SPECIMEN.get(),"Orange-fin Clownfish Specimen");
        this.add(BvfItems.AMPHIPRION_LATEZONATUS_SPECIMEN.get(),"Wide-band Clownfish Specimen");
        this.add(BvfItems.AMPHIPRION_MCCULLOCHI_SPECIMEN.get(),"McCulloch's Clownfish Specimen");
        this.add(BvfItems.AMPHIPRION_MELANOPUS_SPECIMEN.get(),"Cinnamon Clownfish Specimen");
        this.add(BvfItems.AMPHIPRION_TRICINCTUS_SPECIMEN.get(),"Three-band Clownfish Specimen");
