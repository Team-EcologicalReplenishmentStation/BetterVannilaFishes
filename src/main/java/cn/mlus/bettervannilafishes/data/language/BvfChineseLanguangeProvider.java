...
public class BvfChineseLanguangeProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.add(BvfItems.GALEOCERDO_CUVIER_SPAWN_EGG.get(),"居氏鼬鲨生成蛋");        // Surgeonfish Spawn Eggs
        ...
        this.add(BvfItems.ACANTHURUS_LINEATUS_SPAWN_EGG.get(),"彩带刺尾鱼生成蛋");        this.add(BvfItems.HADDOCK_COD_BUCKET.get(), "黑线鳕鱼桶");
        ...
        this.add(BvfItems.GALEOCERDO_CUVIER_BUCKET.get(),"居氏鼬鲨桶");        this.add(BvfItems.ACANTHURUS_ACHILLES_BUCKET.get(),"心斑刺尾鱼桶");
        ...
        this.add(BvfItems.ACANTHURUS_LINEATUS_BUCKET.get(),"彩带刺尾鱼桶");        this.add(BvfItems.HADDOCK_COD.get(), "黑线鳕鱼");
