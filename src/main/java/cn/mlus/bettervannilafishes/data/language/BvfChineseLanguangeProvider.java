...
public class BvfChineseLanguangeProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.add(BvfEntities.SPEARFISH.get(),"四鳍旗鱼");
        //Item
        ...
        this.add(BvfItems.SPEARFISH_SPAWN_EGG.get(),"四鳍旗鱼生成蛋");
        ...
        this.add(BvfItems.SPEARFISH.get(), "四鳍旗鱼");
        this.add(BvfItems.COOKED_SPEARFISH.get(),"熟四鳍旗鱼");
        ...
        this.add(BvfItems.SPEARFISH_SPECIMEN.get(), "四鳍旗鱼标本");
